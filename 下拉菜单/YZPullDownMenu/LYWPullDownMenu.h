...
@class LYWPullDownItem,LYWPullDownMenu;

/**
 *  下拉菜单数据源协议
 */
@protocol LYWPullDownMenuDataSource <NSObject>
...
@interface LYWPullDownMenu : UIView
/**
 *  下拉菜单数据源
 */
@property (nonatomic, weak) id<LYWPullDownMenuDataSource> dataSource;
/**
 *  分割线颜色
 */
