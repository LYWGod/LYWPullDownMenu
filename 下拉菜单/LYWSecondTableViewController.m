//
//  LYWSecondTableViewController.m
//  下拉菜单
//
...
@interface LYWSecondTableViewController ()
...
@implementation LYWSecondTableViewController
...
{
    if (!_dataArr) {
        self.dataArr = [NSMutableArray arrayWithObjects:@"劳资",@"小子",@"孙子",@"孩子",@"你爹",@"你爸",@"鸟毛",@"傻逼",@"二笔",nil];
    }
    return _dataArr;
}
